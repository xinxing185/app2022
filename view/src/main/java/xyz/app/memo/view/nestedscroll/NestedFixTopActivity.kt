...
import xyz.app.memo.view.databinding.ActivityNested2Binding

/**
 *
 * Created by zxx on 2022/7/7 14:30:55
 */
class NestedFixTopActivity: AppCompatActivity() {
    private lateinit var viewBinding: ActivityNested2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding = DataBindingUtil.setContentView(this, R.layout.activity_nested2)
        initList()
        viewBinding.parentView.setScrollHandler(TopScrollHandler())
    }
